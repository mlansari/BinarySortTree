...
public class BST_Playground {
	...
	public static void main(String[] args) {
		...
		BST test = new BST();
		System.out.println("Insert b: " + test.insert("b"));
		System.out.println(test.size);
		System.out.println("Insert a: " + test.insert("a"));
		System.out.println(test.size);
		System.out.println("Insert d: " + test.insert("d"));
		System.out.println(test.size);
		System.out.println("Insert c: " + test.insert("c"));
		System.out.println(test.size);
		System.out.println("Insert f: " + test.insert("f"));
		System.out.println(test.size);
		System.out.println("Insert e: " + test.insert("e"));
